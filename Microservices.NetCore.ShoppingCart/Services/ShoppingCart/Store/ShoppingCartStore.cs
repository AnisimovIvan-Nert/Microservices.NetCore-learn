using Dapper;
using Microservices.NetCore.ShoppingCart.Models.ShoppingCart;
...
public class ShoppingCartStore : IShoppingCartStore
{
    ...
    public async ValueTask<Models.ShoppingCart.ShoppingCart> Create()
    {
        ...
        return new Models.ShoppingCart.ShoppingCart(id);
    }

    public async ValueTask<Models.ShoppingCart.ShoppingCart> Get(int id)
    {
        var @params = new
        {
            ShoppingCartId = id
        ...
        return new Models.ShoppingCart.ShoppingCart(id, items.ToArray());
    }

    public async ValueTask Save(Models.ShoppingCart.ShoppingCart shoppingCart)
    {
